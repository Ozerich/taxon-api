<div class="span12"><h1 class="name">Панель управления</h1>
    ...
    <p style="font-size:14px;"><b>Всего:</b> <a href="/admin/drivers">водителей</a> <span
            class="label label-success"><?= Driver::model()->count(); ?></span>, клиентов <span
            class="label label-success"><?= Order::CountClients(); ?></span></p>
